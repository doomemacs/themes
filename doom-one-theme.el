...
(def-doom-theme doom-one
  ...
  (`(doom-default
   ...
   ;; gnus
   `(gnus-group-mail-1           ((,c (:bold ,bold :inherit gnus-group-mail-1-empty))))
   `(gnus-group-mail-1-empty     ((,c (:inherit gnus-group-news-1-empty))))
   `(gnus-group-mail-2           ((,c (:bold ,bold :inherit gnus-group-mail-2-empty))))
   `(gnus-group-mail-2-empty     ((,c (:inherit gnus-group-news-2-empty))))
   `(gnus-group-mail-3           ((,c (:bold ,bold :inherit gnus-group-mail-3-empty))))
   `(gnus-group-mail-3-empty     ((,c (:inherit gnus-group-news-3-empty))))
   `(gnus-group-mail-low         ((,c (:bold ,bold :inherit gnus-group-mail-low-empty))))
   `(gnus-group-mail-low-empty   ((,c (:inherit gnus-group-news-low-empty))))
   `(gnus-group-news-1           ((,c (:bold ,bold :inherit gnus-group-news-1-empty))))
   `(gnus-group-news-2           ((,c (:bold ,bold :inherit gnus-group-news-2-empty))))
   `(gnus-group-news-3           ((,c (:bold ,bold :inherit gnus-group-news-3-empty))))
   `(gnus-group-news-4           ((,c (:bold ,bold :inherit gnus-group-news-4-empty))))
   `(gnus-group-news-5           ((,c (:bold ,bold :inherit gnus-group-news-5-empty))))
   `(gnus-group-news-6           ((,c (:bold ,bold :inherit gnus-group-news-6-empty))))
   `(gnus-group-news-low         ((,c (:bold ,bold :inherit gnus-group-news-low-empty))))
   `(gnus-header-content         ((,c (:inherit message-header-other))))
   `(gnus-header-from            ((,c (:inherit message-header-other))))
   `(gnus-header-name            ((,c (:inherit message-header-name))))
   `(gnus-header-newsgroups      ((,c (:inherit message-header-other))))
   `(gnus-header-subject         ((,c (:inherit message-header-subject))))
   `(gnus-summary-cancelled      ((,c (:foreground ,orange))))
   `(gnus-summary-high-ancient   ((,c (:foreground ,blue :bold ,bold))))
   `(gnus-summary-high-read      ((,c (:foreground ,green :bold ,bold))))
   `(gnus-summary-high-ticked    ((,c (:foreground ,orange :bold ,bold))))
   `(gnus-summary-high-unread    ((,c (:foreground ,light-grey :bold ,bold))))
   `(gnus-summary-low-ancient    ((,c (:foreground ,blue))))
   `(gnus-summary-low-read       ((t (:foreground ,green))))
   `(gnus-summary-low-ticked     ((,c (:foreground ,orange))))
   `(gnus-summary-low-unread     ((,c (:foreground ,light-grey))))
   `(gnus-summary-normal-ancient ((,c (:foreground ,blue))))
   `(gnus-summary-normal-read    ((,c (:foreground ,green))))
   `(gnus-summary-normal-ticked  ((,c (:foreground ,orange))))
   `(gnus-summary-normal-unread  ((,c (:foreground ,light-grey))))
   `(gnus-summary-selected       ((,c (:foreground ,yellow :bold ,bold))))
   `(gnus-cite-1                 ((,c (:foreground ,blue))))
   `(gnus-cite-2                 ((,c (:foreground ,blue))))
   `(gnus-cite-3                 ((,c (:foreground ,blue))))
   `(gnus-cite-4                 ((,c (:foreground ,green))))
   `(gnus-cite-5                 ((,c (:foreground ,green))))
   `(gnus-cite-6                 ((,c (:foreground ,green))))
   `(gnus-cite-7                 ((,c (:foreground ,red))))
   `(gnus-cite-8                 ((,c (:foreground ,red))))
   `(gnus-cite-9                 ((,c (:foreground ,red))))
   `(gnus-cite-10                ((,c (:foreground ,yellow))))
   `(gnus-cite-11                ((,c (:foreground ,yellow))))
   `(gnus-group-news-1-empty     ((,c (:foreground ,yellow))))
   `(gnus-group-news-2-empty     ((,c (:foreground ,green))))
   `(gnus-group-news-3-empty     ((,c (:foreground ,green))))
   `(gnus-group-news-4-empty     ((,c (:foreground ,blue))))
   `(gnus-group-news-5-empty     ((,c (:foreground ,blue))))
   `(gnus-group-news-6-empty     ((,c (:foreground ,blue))))
   `(gnus-group-news-low-empty   ((,c (:foreground ,light-grey))))
   `(gnus-signature              ((,c (:foreground ,yellow))))
   `(gnus-x-face                 ((,c (:background ,light-grey :foreground ,fg))))
