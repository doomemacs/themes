...
(defgroup doom-everforest-hard-theme nil
  "Options for doom-everforest-hard."
  :group 'doom-themes)

(defcustom doom-everforest-hard-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-everforest-hard-theme
  :type 'boolean)

(defcustom doom-everforest-hard-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-everforest-hard
  ...
  ((bg         '("#1e2326" "#1e2326" nil          )) ; bg1
   (bg-alt     '("#272e33" "#272e33" nil          )) ; bg1
   (bg-alt2    '("#2e383c" "#2e383c" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#1e2326" "black"   "black"      )) ; (self-defined)
   (base1      '("#272e33" "#272e33" "brightblack")) ; bg0_h
   (base2      '("#2e383c" "#2e383c" "brightblack")) ; bg0
   (base3      '("#374145" "#374145" "brightblack")) ; bg1
   (base4      '("#414b50" "#414b50" "brightblack")) ; bg3
   (base5      '("#495156" "#495156" "brightblack")) ; bg4
   (base6      '("#859289" "#859289" "brightblack")) ; gray
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-everforest-hard-brighter-comments magenta grey))
   (doc-comments   (if doom-everforest-hard-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      cyan)
   (keywords       red)
   (methods        cyan)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-everforest-hard-padded-modeline
      (if (integerp doom-everforest-hard-padded-modeline)
          doom-everforest-hard-padded-modeline
        4)))
...
;;; doom-everforest-hard-theme.el ends here
