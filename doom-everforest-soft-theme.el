...
(defgroup doom-everforest-soft-theme nil
  "Options for doom-everforest-soft."
  :group 'doom-themes)
...
(def-doom-theme doom-everforest-soft
  ...
  ((bg         '("#293136" "#293136" nil          )) ; bg1
   (bg-alt     '("#333c43" "#333c43" nil          )) ; bg1
   (bg-alt2    '("#3a464c" "#3a464c" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#293136" "black"   "black"      )) ; (self-defined)
   (base1      '("#333c43" "#333c43" "brightblack")) ; bg0_h
   (base2      '("#3a464c" "#3a464c" "brightblack")) ; bg0
   (base3      '("#434f55" "#434f55" "brightblack")) ; bg1
   (base4      '("#4d5960" "#4d5960" "brightblack")) ; bg3
   (base5      '("#555f66" "#555f66" "brightblack")) ; bg4
   (base6      '("#5d6b66" "#5d6b66" "brightblack")) ; gray
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-everforest-soft-brighter-comments magenta grey))
   (doc-comments   (if doom-everforest-soft-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      cyan)
   (keywords       red)
   (methods        cyan)
