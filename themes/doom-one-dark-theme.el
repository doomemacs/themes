;;; doom-one-dark-theme.el --- inspired by doom one Theme -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-one-dark-theme nil
  "Options for doom-themes"
  :group 'doom-themes)
(defcustom doom-one-dark-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-one-dark-theme
  :type '(choice integer boolean))
(defcustom doom-one-dark-blue-modeline nil
  "If non-nil, mode-line's color will be blue instead of the default purple."
  :group 'doom-one-dark-theme
  :type '(choice integer boolean))
;;
(def-doom-theme doom-one-dark
  "A dark theme inspired by black Theme by equinusocio"
  ;; name        default   256       16
  ((bg         '("#000000" "#000000" nil))
   ...
   (vc-deleted     red)
   ;; custom categories
   (modeline-bg     (if doom-one-dark-blue-modeline base6 dark-violet))
   (modeline-bg-alt (doom-darken bg 0.01))
   (modeline-fg     base8)
   (modeline-fg-alt blue)
   (-modeline-pad
    (when doom-one-dark-padded-modeline
      (if (integerp doom-one-dark-padded-modeline) doom-one-dark-padded-modeline 4))))
  ;; --- base faces ------------------------
  ((highlight            :background highlight  :foreground base8 :distant-foreground base8)
   ...
   ;; doom-modeline
   (doom-modeline-bar :background (if doom-one-dark-blue-modeline base6 dark-violet))
