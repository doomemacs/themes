...
(def-doom-theme doom-monokai-ristretto
  ...
  ((bg         '("#2c2525" nil       nil            ))
   ...
   (base1      '("#211c1c" "#696969" "black"        ))
   (base2      '("#191515" "#808080" "brightblack"  ))
   (base3      '("#2c2525" "#808080" "brightblack"  ))
   (base4      '("#403838" "#a9a9a9" "brightblack"  ))
   (base5      '("#5b5353" "#a9a9a9" "brightblack"  ))
   (base6      '("#72696a" "#6c6c6c" "brightblack"  ))
   (base7      '("#948a8b" "#8a8a8a" "brightblack"  ))
   (base8      '("#c3b7b8" "#bcbcbc" "white"        ))
   (fg         '("#fff1f3" "#ffffff" "brightwhite"  ))
   (fg-alt     '("#e5d8da" "#c6c6c6" "white"        ))
