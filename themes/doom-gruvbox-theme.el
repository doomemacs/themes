...
(def-doom-theme doom-gruvbox
  ...
  (
   ...
   ((outline-4 &override) :foreground (doom-lighten violet) 0.20)
   ((outline-5 &override) :foreground (doom-lighten dark-cyan) 0.25)
   ((outline-6 &override) :foreground (doom-lighten violet) 0.40)
   ((outline-7 &override) :foreground (doom-lighten dark-cyan) 0.50)
   ((outline-8 &override) :foreground (doom-lighten violet) 0.60)
   (org-code :foreground orange)
   (org-date :foreground green)
   (org-document-info :foreground red)
   (org-document-title :foreground red)
   (org-drawer :foreground (doom-lighten cyan 0.40))
   (org-ellipsis :underline nil :foreground orange)
   (org-formula :foreground green)
   (org-link :foreground violet :weight bold :underline t)
   (org-list-dt :foreground cyan)
   ((org-quote &override) :inherit 'italic :foreground base7 :background org-quote)
   (org-table :foreground cyan)
   (org-tag :foreground "#7c6f64")
   (org-todo :foreground olive :bold 'inherit)
