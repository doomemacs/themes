...
(def-doom-theme doom-gruvbox
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   (markdown-header-face-1 :inherit 'bold :foreground green :height 1.12)
   (markdown-header-face-2 :inherit 'bold :foreground orange :height 1.10)
   (markdown-header-face-3 :bold nil :foreground yellow :height 1.08)
   (markdown-header-face-4 :bold nil :foreground yellow :height 1.05)
   (markdown-header-face-5 :foreground dark-cyan :height 1.03)
