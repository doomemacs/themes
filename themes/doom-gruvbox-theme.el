...
(def-doom-theme doom-gruvbox
  ...
  ((bg
   ...
   (my_orange   '("#d65d0e" "#d65d0e" "orange"))        ; bright-orange
   ...
   (my_blue     '("#318ce0" "#318ce0" "brightblue"))    ; bright-blue
   (dark-blue   '("#458588" "#458588" "blue"))          ; blue
   (cyan        '("#8ec07c" "#8ec07c" "brightcyan"))    ; bright-aqua
   (my-black    '("#37302f" "#37302f" "brightcyan"))    ; bright-aqua
  ...
  (
   ...
   ;;;;;;;; Doom-modeline ;;;;;;;;
   (mode-line
    :background my-black :foreground (doom-lighten fg-alt 0.25)
