...
(def-doom-theme doom-gruvbox-light
  ...
  ((cursor :background base4)
   ...
   (markdown-header-face-1   :inherit 'bold :foreground blue :height 1.20)
   (markdown-header-face-2   :inherit 'bold :foreground yellow :height 1.15)
   (markdown-header-face-3   :bold nil :foreground violet :height 1.10)
   (markdown-header-face-4   :bold nil :foreground red :height 1.05)
   (markdown-header-face-5   :foreground green :height 1.00)
