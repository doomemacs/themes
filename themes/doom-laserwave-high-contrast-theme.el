;;; doom-laserwave-theme-high-contrast-theme.el --- a high contrast variant of Laserwave -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Author: Justin Barclay <https://github.com/justinbarclay>
;; Maintainer:
...
(defgroup doom-laserwave-high-contrast-theme nil
  "Options for the `doom-laserwave-high-contrast' theme."
  :group 'doom-themes)
...
(def-doom-theme doom-laserwave-high-contrast
  ...
  ((bg         '("#19151E" nil       nil             ))
   ...
   (base6      '("#ED60BA" "#EE66BB" "magenta"       ))
   (base7      '("#B4ABBE" "#998899" "brightblack"   ))
   (base8      '("#ECEFF4" "#EEEEFF" "white"         ))
   (fg-alt     '("#EEEEEE" "#EEEEEE" "brightwhite"   ))
   (fg         '("#FFFFFF" "#FFFFFF" "white"         ))

   (grey       '("#B4A8C8" "#4E415C" "brightblack"   ))
   (red        '("#FF3E7B" "#964477" "red"           ))
   (orange     '("#FFB85B" "#FFBB55" "brightred"     ))
   (green      '("#3FEABF" "#77DDCC" "green"         ))
   ...
   (selection      `(,(doom-blend (car bg) (car magenta) 0.6) ,@(doom-lighten (cdr base1) 0.35)))
   (builtin        yellow)
   (comments       base7)
  ...
  ((lazy-highlight :background (doom-darken magenta 0.4) :foreground fg)
   ...
   ;;;; tsx
   (typescript-ts-jsx-attribute-face :foreground magenta)
   (typescript-ts-jsx-tag-face :foreground green)
...
;;; doom-laserwave-high-contrast-theme.el ends here
