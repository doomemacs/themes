...
(def-doom-theme doom-ayu-light
  ...
  (
   ...
   (builtin        syntax-func)
   (comments       (if doom-ayu-mirage-brighter-comments syntax-comment elscreen-bg))
   (doc-comments   (doom-lighten (if doom-ayu-mirage-brighter-comments syntax-comment elscreen-bg) 0.25))
