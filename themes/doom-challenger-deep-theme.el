...
(def-doom-theme doom-challenger-deep
  ...
  ((bg         '("#1b182c" "#1c1c1c" nil            ))
   ...
   (selection      violet)
   (builtin        magenta)
   (comments       (if doom-challenger-deep-brighter-comments (doom-darken dark-cyan 0.3) base5))
   (doc-comments   (if doom-challenger-deep-brighter-comments (doom-darken dark-cyan 0.2) base5))
   (constants      cyan)
   (functions      magenta)
   (keywords       red)
   (methods        magenta)
