;;; doom-tokyo-night-storm-theme.el --- inspired by VSCode's Tokyo Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defcustom doom-tokyo-night-storm-comment-bg doom-tokyo-night-storm-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'doom-tokyo-night-storm-theme
  :type 'boolean)

(defcustom doom-tokyo-night-storm-padded-modeline nil
...
(def-doom-theme doom-tokyo-night-storm
  "A variant of Tokyo Night with a lighter background."
  ...
  ; "#24283b" "#24283b" => Editor background

  ;; name        default   256       16
  ((bg         '("#24283b" nil       nil            ))
   (bg-alt     '("#1d202f" nil       nil            ))
   ...
   (selection      base0)
   (builtin        red)
   (comments       (if doom-tokyo-night-storm-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if doom-tokyo-night-storm-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-tokyo-night-storm-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
