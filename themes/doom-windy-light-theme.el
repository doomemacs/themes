...
(def-doom-theme doom-windy-light
    ...
    (
        ...
        (mu4e-flagged-face
            :foreground indigo
            :background (doom-blend bg indigo 0.9))
        ...
        (mu4e-unread-face
            :foreground fuchsia
            :background (doom-blend bg fuchsia 0.9)
            :weight 'bold)
        ;;;; nav-flash
        ...
        ((outline-4 &override)
            :foreground (doom-blend fg orange  (if doom-windy-light-brighter 0.25 0.33)))
        ((outline-5 &override)
            :foreground (doom-blend fg lime    (if doom-windy-light-brighter 0.25 0.33)))
        ((outline-6 &override)
        ...
        (transient-key-return      :inherit 'transient-key :foreground orange)
