...
(defconst doom-themes-common-faces
  '(;; --- custom faces -----------------------
   ...
   (notmuch-wash-toggle-button              :foreground fg)
    ...
    (org-agenda-date         :font "SF Compact Display" :foreground (doom-darken yellow 0.2) :weight 'bold  :height 1.6)
    (org-agenda-date-today   :font "SF Compact Display" :foreground (doom-darken blue 0.2)   :weight 'bold  :height 1.6)
    (org-agenda-date-weekend :font "SF Compact Display" :foreground (doom-darken green 0.2)  :weight 'bold  :height 1.6)
    (org-agenda-structure    :font "SF Compact Display" :foreground (doom-darken violet 0.2) :weight 'bold  :height 1.4)
    (org-agenda-clocking      :background dark-blue)
    (org-upcoming-deadline    :foreground (doom-darken red 0.2) :bold bold)
    ...
    (org-todo-keyword-todo :foreground (doom-darken blue 0.2)    :background (doom-blend blue bg 0.2)    :bold bold)
    (org-todo-keyword-habt :foreground (doom-darken yellow 0.2)  :background (doom-blend yellow bg 0.2)  :bold bold)
    (org-todo-keyword-done :foreground (doom-darken green 0.2)   :background (doom-blend green bg 0.2)   :bold bold)
    (org-todo-keyword-wait :foreground (doom-darken red 0.2)     :background (doom-blend red bg 0.2)     :bold bold)
    (org-todo-keyword-kill :foreground (doom-darken magenta 0.2) :background (doom-blend magenta bg 0.2) :bold bold)
    (org-todo-keyword-outd :foreground (doom-darken fg 0.2)      :background (doom-blend fg bg 0.2)      :bold bold)
