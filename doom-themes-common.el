...
(defvar doom-themes-common-faces
  '(;; --- custom faces -----------------------
    ...
    (diredfl-compressed-file-suffix :foreground (doom-blend orange bg 0.6) :background bg)
    (diredfl-date-time              :foreground cyan :background bg :weight 'light)
    ...
    (diredfl-dir-heading            :foreground blue :background bg :weight 'bold)
    ...
    (diredfl-file-suffix            :foreground (doom-blend fg bg 0.6) :background bg)
