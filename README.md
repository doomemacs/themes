...
| doom-kanagawa-abyss               | [link](https://github.com/rebelot/kanagawa.nvim)                                       | based on rebelot's neovim colorscheme, hybrid of wave and dragon (ported by [@Anskrevy](https://github.com/Anskrevy))             |
| doom-kanagawa-dragon              | [link](https://github.com/rebelot/kanagawa.nvim)                                       | based on rebelot's neovim colorscheme (ported by [@Anskrevy](https://github.com/Anskrevy))                                        |
| doom-kanagawa-lotus               | [link](https://github.com/rebelot/kanagawa.nvim)                                       | based on rebelot's neovim colorscheme (ported by [@Anskrevy](https://github.com/Anskrevy))                                        |
| doom-kanagawa-wave                | [link](https://github.com/rebelot/kanagawa.nvim)                                       | based on rebelot's neovim colorscheme (ported by [@Anskrevy](https://github.com/Anskrevy))                                        |
